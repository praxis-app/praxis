...
export type JoinedGroupsFeedQueryVariables = Types.Exact<{
...
export type JoinedGroupsFeedQuery = {
  __typename?: 'Query';
  joinedGroupsFeedCount: number;
  joinedGroupsFeed: Array<
    | {
        __typename?: 'Post';
        id: number;
        body?: string | null;
...
export const JoinedGroupsFeedDocument = gql`
  query JoinedGroupsFeed(
    ...
    joinedGroupsFeedCount
  }
  ${FeedItemFragmentDoc}
`;

/**
 * __useJoinedGroupsFeedQuery__
 *
 * To run a query within a React component, call `useJoinedGroupsFeedQuery` and pass it any options that fit your needs.
 * When your component renders, `useJoinedGroupsFeedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useJoinedGroupsFeedQuery({
 *   variables: {
 ...
 * });
 */
export function useJoinedGroupsFeedQuery(
  baseOptions?: Apollo.QueryHookOptions<
    JoinedGroupsFeedQuery,
    JoinedGroupsFeedQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<JoinedGroupsFeedQuery, JoinedGroupsFeedQueryVariables>(
    JoinedGroupsFeedDocument,
    options,
  );
}
export function useJoinedGroupsFeedLazyQuery(
  ...
  return Apollo.useLazyQuery<
    JoinedGroupsFeedQuery,
    JoinedGroupsFeedQueryVariables
  >(JoinedGroupsFeedDocument, options);
}
export type JoinedGroupsFeedQueryHookResult = ReturnType<
  typeof useJoinedGroupsFeedQuery
>;
export type JoinedGroupsFeedLazyQueryHookResult = ReturnType<
  typeof useJoinedGroupsFeedLazyQuery
>;
export type JoinedGroupsFeedQueryResult = Apollo.QueryResult<
  JoinedGroupsFeedQuery,
  JoinedGroupsFeedQueryVariables
>;
