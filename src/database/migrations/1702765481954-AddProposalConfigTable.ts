...
export class AddProposalConfigTable1702765481954 implements MigrationInterface {
  name = 'AddProposalConfigTable1702765481954';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "proposal_config" ("id" SERIAL NOT NULL, "decisionMakingModel" character varying NOT NULL, "standAsidesLimit" integer NOT NULL, "reservationsLimit" integer NOT NULL, "ratificationThreshold" integer NOT NULL, "votingEndsAt" TIMESTAMP, "proposalId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_9b5d32fef3ec87bf111c964f2c" UNIQUE ("proposalId"), CONSTRAINT "PK_2f0858babf4bb7af66b142b83f8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
